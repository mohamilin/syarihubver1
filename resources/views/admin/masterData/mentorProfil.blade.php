            ...
            <div class="profile-widget profile-widget-info">
              <div class="panel-body">
                ...
                <div class="col-lg-4 col-sm-4 follow-info">
                  <p><i>{{ $data_mentor->alamat }}</i></p>
                  <p><i>{{ $data_mentor->no_whatsapp }}</i></p>
                </div>
                ...
                <div class="tab-content">
                  ...
                  <div id="profile" class="tab-pane">
                    <section class="panel">
                      ...
                      Assalamualaikum. saya <i>{{$data_mentor->nama_lengkap}}</i>, saya sebagai driver Lorem Ipsum is not simplyLorem Ipsum is not simply
                      </div>
                      <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                          <div class="bio-row">
                          <div class="bio-row">
                            <p><span>ID mentor </span>: {{$data_mentor->id_mentor}}</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Nama Lengkap </span>: {{$data_mentor->nama_lengkap}} </p>
                          </div>                          
                          <div class="bio-row">
                            <p><span>Tanggal Lahir</span>: {{$data_mentor->tanggal_lahir}}</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Juz yang Dihafal </span >: {{$data_mentor->jml_juz}}</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Pendidikan </span>:  {{$data_mentor->pendidikan}}</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Pengalaman </span>: {{$data_mentor->pengalaman}}</p>
                          </div>
                          <div class="bio-row">
                            <p><span>No. HP </span>:{{$data_mentor->no_whatsapp}}</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Alamat Domisili </span>: {{$data_mentor->alamat}}</p>
                          </div>
                        </div>
                      </div>
                    </section>
                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <form class="form-horizontal" role="form">
                          <div class="form-group">
                            <label class="col-lg-2 control-label">ID mentor</label>
                            <div class="col-lg-2">
